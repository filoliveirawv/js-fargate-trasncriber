...
graph TD
    ...
    FARGATE_TASK -- "14. Injects Timed Metadata" --> IVS_CHANNEL
    FARGATE_TASK -- "15. Calls API to Save Transcript" --> ENDPOINT

    IVS_CHATROOM -- "13. Pushes Event to Viewer" --> VIEWER
    ENDPOINT -- "16. Saves to DB" --> DB
